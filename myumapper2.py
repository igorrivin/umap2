...
class myUMAP:
    def __init__(self, dimension=2, n_neighbors=10, sigma_tol=1e-6, max_iter_sigma=200, max_iter_layout=100,
                 min_dist=1e-1, symmetrize=False, n_oversamples=None, multiplier=0.5):
